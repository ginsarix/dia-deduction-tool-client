    ...
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            <span className="font-semibold text-[#e0e0e0]">{worker.name}</span>{" "}
...
function SyncWorkersButton({
  ...
  return (
    <Button
      size="sm"
      variant="ghost"
      className="cursor-pointer gap-1.5 text-[#525252] hover:text-[#c8c8c8]"
      onClick={handleSync}
      disabled={loading}
    >
      {loading ? (
      ...
      >
        ...
        {workersLoading ? (
                  ...
                  >
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-2">
                        <IdCardLanyardIcon className="w-3.5 h-3.5 text-[#404040] flex-shrink-0" />
          ...
          <div className="flex flex-col items-center justify-center py-16 gap-3">
            <IdCardLanyardIcon className="w-8 h-8 text-[#2a2a2a]" />
            <p className="text-sm font-mono text-[#383838]">
              Henüz personel yok
            </p>
            {connections.length > 0 ? (
